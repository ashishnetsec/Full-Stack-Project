...
export default async function productPage() {
    ...
    const statusName = ["status", "top_selling", "stock"] 
            ...
            <div className="flex items-center justify-between mb-6">
                <div>
                    ...
                    <p className="text-sm text-gray-500">
                        Manage product, images and SEO-friendly slugs
                    </p>
                </div>
                        ...
                        {product.map((cat) => (
                            ...
                            <tr key={cat._id} className="border-t hover:bg-gray-50 transition">
...

                                {
                                    statusName.map((data, index) => {
                                        ...
                                        return <td key={index} className="px-6 py-4 ">
                                            <StatusBtn cat={cat} data={data} path="product" />
                                        </td>
                                    })
                                }
                                ...
                                <td className="px-6 py-4 flex justify-center gap-3">
                                    ...
                                    <Link href={`/admin/product/edit/${cat.slug}`}>
                                    ...
                                    <DeleteBtn cat={cat} value = "product" />
